...
(0, ava_1.default)(`Parse Extractor inputs`, async (t) => {
...
(0, ava_1.default)(`Parse Extractor inputs with version`, async (t) => {
    await util.withTmpDir(async (tmpDir) => {
        (0, testing_utils_1.setupActionsVars)(tmpDir, tmpDir);
...
(0, ava_1.default)(`Parse empty extractor inputs`, async (t) => {
    await util.withTmpDir(async (tmpDir) => {
        (0, testing_utils_1.setupActionsVars)(tmpDir, tmpDir);
...
(0, ava_1.default)("Parse multiple Extractor inputs", async (t) => {
    await util.withTmpDir(async (tmpDir) => {
        (0, testing_utils_1.setupActionsVars)(tmpDir, tmpDir);
...
(0, ava_1.default)(`Parse Extractor inputs with multiple versions`, async (t) => {
    await util.withTmpDir(async (tmpDir) => {
        (0, testing_utils_1.setupActionsVars)(tmpDir, tmpDir);
...
(0, ava_1.default)("Parsing spec with various issues", async (t) => {
    await util.withTmpDir(async (tmpDir) => {
        (0, testing_utils_1.setupActionsVars)(tmpDir, tmpDir);
...
(0, ava_1.default)("Version with tag like path", async (t) => {
    await util.withTmpDir(async (tmpDir) => {
        (0, testing_utils_1.setupActionsVars)(tmpDir, tmpDir);
...
(0, ava_1.default)(`Parse arbitrary organisation`, async (t) => {
    await util.withTmpDir(async (tmpDir) => {
        (0, testing_utils_1.setupActionsVars)(tmpDir, tmpDir);
...
(0, ava_1.default)(`Parse arbitrary repository`, async (t) => {
    await util.withTmpDir(async (tmpDir) => {
        (0, testing_utils_1.setupActionsVars)(tmpDir, tmpDir);
        t.throws(() => {
